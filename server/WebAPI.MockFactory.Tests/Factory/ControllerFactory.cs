namespace WebAPI.MockFactory.Tests.Factory
{
    ...
    public class ControllerFactory : IControllerFactory
    {
        ...
        public CategoriesController CreateCategoriesController()
        {
            return new CategoriesController(_loggerFactory.CreateLogger<CategoriesController>(), _serviceFactory.CreateCategoryService());
        }
    }
}
